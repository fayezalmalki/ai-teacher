...
export default function ExplainPage() {
  ...
  // Speaking duration = max(2200ms, 60ms × chars). Replace with the real TTS end event.
  useEffect(() => {
      ...
      <div className="flex-1 flex flex-col">
        <div className="flex-1 grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-8 px-8 pt-9 pb-6">
          <div className="flex flex-col items-start gap-5">
            <Teacher size={180} glyphSize={74} border={8} ringInset={8} state={speaking ? "speaking" : "idle"} />
